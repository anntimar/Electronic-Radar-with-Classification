...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RADAR_SENSOR_DISTANCE_MM, 2000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RADAR_SPEED_LIMIT_LIGHT_KMH, 80);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RADAR_SPEED_LIMIT_HEAVY_KMH, 60);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RADAR_WARNING_THRESHOLD_PERCENT, 90);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RADAR_CAMERA_FAILURE_RATE_PERCENT, 20);
